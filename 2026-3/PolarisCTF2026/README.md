...
| challenge name | author         | Difficulty | status   | solutions | points |
| -------------- | -------------- | ---------- | -------- | --------- | ------ |
| ez_login       | Spreng         | easy       | solved   | 351       | 100    |
| RSA_LCG        | Chestnut       | hard       | solved   | 37        | 593    |
...
Thanks to all authors' ellagent problems!
